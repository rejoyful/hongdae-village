...
function load(): PetState {
  const base: PetState = {
    owned: [], active: null, affinity: {}, fedDay: {}, feeds: 0, unlocked: [],
    playedDay: {}, trainedDay: {}, plays: {}, trainings: {}, tricks: {}, feedsByPet: {},
    nicknames: {}, personalities: {}, accessories: {}, styled: [],
  };
  try {
    ...
    return {
      ...
      playedDay: raw.playedDay && typeof raw.playedDay === 'object' ? raw.playedDay : {},
      trainedDay: raw.trainedDay && typeof raw.trainedDay === 'object' ? raw.trainedDay : {},
      plays: raw.plays && typeof raw.plays === 'object' ? raw.plays : {},
      trainings: raw.trainings && typeof raw.trainings === 'object' ? raw.trainings : {},
      tricks: raw.tricks && typeof raw.tricks === 'object' ? raw.tricks : {},
      feedsByPet: raw.feedsByPet && typeof raw.feedsByPet === 'object' ? raw.feedsByPet : {},
      nicknames: raw.nicknames && typeof raw.nicknames === 'object' ? Object.fromEntries(
        Object.entries(raw.nicknames).flatMap(([id, value]) => {
      ...
      personalities: raw.personalities && typeof raw.personalities === 'object' ? Object.fromEntries(
        Object.entries(raw.personalities).filter(([, value]) => isPetPersonalityId(value)),
      ) as Record<string, PetPersonalityId> : {},
      accessories: raw.accessories && typeof raw.accessories === 'object' ? Object.fromEntries(
        Object.entries(raw.accessories).filter(([, value]) => isPetAccessoryId(value)),
      ) as Record<string, PetAccessoryId> : {},
      styled: Array.isArray(raw.styled)
        ? [...new Set<string>((raw.styled as unknown[]).filter((id): id is string => typeof id === 'string'))] : [],
    };
  } catch { return base; }
}
